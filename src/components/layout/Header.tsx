      ...
      <div className="flex items-center gap-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56" align="end" forceMount>
            ...
            <DropdownMenuSeparator />
            <div className="p-2">
              <p className="text-xs text-muted-foreground mb-2 font-medium px-2">Switch Role</p>
              <div className="flex flex-col gap-1">
                ...
                >
                  Admin (Full Access)
                  {role === "admin" && <Badge variant="default" className="ml-auto text-[10px] h-4">Active</Badge>}
                </Button>
                <Button 
                ...
                >
                  Viewer (Read Only)
                  {role === "viewer" && <Badge variant="default" className="ml-auto text-[10px] h-4">Active</Badge>}
                </Button>
              </div>
            </div>
            <DropdownMenuSeparator />
