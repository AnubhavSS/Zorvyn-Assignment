    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <motion.div variants={item}>
          <Card className="bg-primary text-primary-foreground min-h-45">
            <CardContent className="p-6">
              <Lightbulb className="w-8 h-8 mb-4 opacity-80" />
              <h3 className="text-lg font-semibold mb-2">Primary Expense</h3>
              <p className="text-primary-foreground/80 text-sm">
                You spend most of your money on <strong className="text-white">Housing</strong>, 
                making up 67% of your total lifetime expenses.
              </p>
            </CardContent>
          </Card>
        </motion.div>
          ...
          <Card className="min-h-45">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground text-sm">
                Your expenses are <strong className={"text-emerald-500"}>
                  20% higher
            ...
            <CardContent className="h-75">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <XAxis type="number" stroke="hsl(var(--muted-foreground))" tickFormatter={(val) => `₹${(val/1000).toFixed(1)}k`} fontSize={12} />
